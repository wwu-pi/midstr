...
public class PatecaruLaunchConfigurationDelegate extends JUnitLaunchConfigurationDelegate {

	public static final String	LAUNCH_CONFIG_ID	= "de.wwu.pi.patecaru.eclipse.launchConfigurationType";	//$NON-NLS-1$
	...
	public synchronized void launch(ILaunchConfiguration configuration, String mode, ILaunch launch, IProgressMonitor monitor) throws CoreException {
		...
		try {
			...
			String mainTypeName= "de.wwu.pi.patecaru.eclipse.runner.PatecaruEclipseTestRunner"; verifyMainTypeName(configuration);
	...
	public String[] getClasspath(ILaunchConfiguration configuration) throws CoreException {
		...
		classPath[classPath.length-1] = "C:\\Users\\a_fuch05\\workspace\\neon-junit\\de.wwu.pi.patecaru.eclipse\\bin";
		return classPath;
	}
